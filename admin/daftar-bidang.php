...
<div id="layoutSidenav_content">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <button class="btn btn-primary mb-2" data-toggle="modal" data-target="#modalTambah"><i
                                ...
                                <tr>
                                    ...
                                    <td width="15%" class="text-center">
                                        <button class="btn btn-success btn-sm mb-1" data-toggle="modal" data-target="#modalUbah<?= $data['id_bidang'];?>""><i class="fas fa-edit"></i>
                                            Ubah</button>
                                        <a href="hapus-bidang.php?id_bidang=<?= $data['id_bidang'];?>"
                                            class="btn btn-danger btn-sm mb-1"
                                            onclick="return confirm('Yakin Data Bidang Akan Dihapus.?');"><i
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="Tambah" class="btn btn-primary btn-sm">Sumbit</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <?php foreach ($bidang as $data) : ?>
        <!-- Modal Ubah -->
        <div class="modal fade" id="modalUbah<?= $data['id_bidang']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
